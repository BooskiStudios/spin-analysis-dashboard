...
function createEvents(duration: number, cascades: number, bonusTriggered: boolean) {
...
function createSpin(spinNumber: number, winAmount: number, cascades: number, bonusTriggered: boolean, duration: number): SeedSpin {
  return {
    spinNumber,
    winAmount,
    cascades,
